...
const COPY = {
  ...
  heroBody:
    '<b>در گِلو، هر گوشه از خانه می‌تواند بازتابی از سلیقه‌ی شما باشد.</b><br> از آباژور و شیدهای دست‌دوز تا اکسسوری‌های خاص خانه، هر محصول با دقت و عشق ساخته می‌شود. همچنین می‌توانید با انتخاب رنگ، پارچه و جزئیات مورد علاقه‌تان، سفارش خود را مطابق با سلیقه و فضای خانه‌تان شخصی‌سازی کنید.',
